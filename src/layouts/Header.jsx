...
export const Header = () => {
  ...
  return (
    <div>
      ...
      <header className={`w-full flex justify-between items-center ${YYYY || SearchQ ? '' : 'sm:absolute'} top-0 sm:z-20 relative bg-transparent text-gray-900 p-4`}>
        <button onClick={() => navigate('/')} className='font-amatic hover:animate-pulse sm:text-6xl text-4xl font-extrabold font-outline-2'>VOODOO</button>
